...
const RULES = {
    ...
    FRONTEND_BOX_SPACING_UNIT: define('Box spacing uses a forbidden CSS unit', 'styling', 'Margin, padding, gap, and scroll spacing use px, %, unitless zero, CSS platform environment values, or applicable semantic keywords.', 'Convert the value to an allowed spacing unit, a CSS env() platform value whose fallback is valid when present, or a shared token resolving to one.'),
